...
class BlenvyManager(PropertyGroup):
    ...
    # computed property for the absolute path of assets
    export_assets_path_full: StringProperty(
    ...
    export_blueprints_path_full: StringProperty(
    ...
    # computed property for the absolute path of blueprints
    export_levels_path_full: StringProperty(
    ...
    # computed property for the absolute path of blueprints
    export_materials_path_full: StringProperty(
