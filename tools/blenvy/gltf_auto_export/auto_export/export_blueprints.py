...
def export_blueprints(blueprints, addon_prefs, blueprints_data):
    blueprints_path_full = getattr(addon_prefs, "export_blueprints_path_full")
    ...
    try:
        ...
        for blueprint in blueprints:
            ...
            generate_and_export(
                ...
                temp_scene_filler=lambda temp_collection: copy_hollowed_collection_into(collection, temp_collection, blueprints_data=blueprints_data, addon_prefs=addon_prefs),
                temp_scene_cleaner=lambda temp_scene, params: clear_hollow_scene(original_root_collection=collection, temp_scene=temp_scene, **params)
            )
